...
class AddItemPublicFragment : Fragment() {
    private var _binding: FragmentAddItemPublicBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddItemPublicBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.saveBtn.setOnClickListener {
            ...
            turnOffSaveBtn()
            selectedProduct?.let { it1 -> viewModel.addProductToInvent(it1.id,quantityStr,note) }
        }
